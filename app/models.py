...
class Postulacion(models.Model):
    ...
    ap_materno = models.CharField(max_length=15, verbose_name='Apellido Materno')
    comuna = models.IntegerField(choices=comunas_santiago, verbose_name='Comuna donde vive')
    ...
    describir_experiencia = models.TextField(max_length=250,verbose_name='Describa su Experiencia')
    cv = models.FileField(verbose_name=('Adjuntar Curriculum Vitae'), upload_to="CVs",null=True, blank=True, validators=[FileExtensionValidator(allowed_extensions=["pdf","doc","docx"])])
